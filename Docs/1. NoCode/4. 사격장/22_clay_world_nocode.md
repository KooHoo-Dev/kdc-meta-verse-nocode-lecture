...
> 💡 **풀고 싶으면 `Esc`, 돌아오려면 화면 클릭**
>
> **`Esc` 를 누르면 커서가 다시 나타납니다.**
> 그 상태에서 **화면을 한 번 누르면 다시 잠깁니다.** 둘러보기도 돌아옵니다.
>
> ▶ 를 끄고 싶은데 커서가 없어서 못 누르실 때, `Esc` 를 기억하세요.
...
| **Lock Cursor** | 커서를 잠글지 (`Esc` 로 잠깐 풀고, 화면을 누르면 다시 잠깁니다) | 체크 켜고 끄기 |
...
8. **`Space`** 로 점프해봅니다.
9. **`Esc`** 를 눌러 커서를 되찾아봅니다.
10. **화면을 한 번 클릭**해봅니다. → **다시 잠기고 둘러보기가 돌아옵니다.**
11. 다시 **`Esc`** 를 누르고 ▶ 를 끕니다.
...
>
> 그리고 **화면을 다시 클릭하면 잠깁니다.** 둘러보기를 이어서 하실 수 있어요.
>
...
그리고 **화면을 다시 클릭하면 잠깁니다.** 둘러보기를 이어서 할 수 있어요.
...
> - [ ] 씬 파일을 **`22_완성` 처럼 복사**해두기 (되돌아갈 때 편합니다)
