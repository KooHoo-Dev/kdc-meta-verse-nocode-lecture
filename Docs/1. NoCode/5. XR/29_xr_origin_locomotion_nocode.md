...
!!! warning "그냥 마우스만 움직이면 시점이 안 돕니다"
...
**28차시에 끌어다 놓은 붕어빵 틀 안에** 전부 들어 있습니다. 조종석을 내려보면 보입니다.

| 조종석에 보이는 이름 | 하는 일 | 오늘 |
| :--- | :--- | :--- |
| **Dynamic Move Provider** | 걷기 | 실습 ③에서 껐다 켬 |
| **Snap Turn Provider** | 딱딱 끊어 돌기 | 실습 ④에서 갈아 끼움 |
| **Continuous Turn Provider** | 부드럽게 돌기 | 〃 |
| **Teleportation Provider** | 순간이동 | **31차시에 씁니다** |
...
1. ▶ 를 **끕니다.**
2. **Hierarchy**에서 **맨 위 `XR Origin (XR Rig)`** 을 고릅니다.
3. **조종석(Inspector)** 을 **아래로 쭉 내려봅니다.**

이런 이름들이 보일 겁니다.

| 조종석에 보이는 이름 | 하는 일 |
| :--- | :--- |
| **Dynamic Move Provider** | **걷기** |
| **Snap Turn Provider** | **딱딱 끊어 돌기** |
| **Continuous Turn Provider** | **부드럽게 돌기** |
| **Teleportation Provider** | **순간이동** (31차시에 씁니다) |
| **Grab Move Provider** | 손으로 세상을 끌어당겨 이동 |

!!! success "여러분은 아무것도 안 붙였습니다"
    **28차시에 끌어다 놓은 붕어빵 틀에 처음부터 다 들어 있었습니다.**

    이게 **붕어빵 틀의 힘**입니다. 15차시에 자동차 틀 하나로 다섯 대를 놓으셨죠?
    여기서는 **VR에 필요한 부품 한 무더기**가 틀 하나에 담겨 있었던 겁니다.

!!! note "이름이 많아서 어지러우시면"
    **지금은 몰라도 됩니다.** 위 표에서 **위 세 줄만** 보시면 오늘은 충분합니다.

#### **2단계 — 껐다 켜서 확인하기**

정말 그 부품이 걷기를 담당하는지 **직접 확인**해봅니다.

1. **`Dynamic Move Provider`** 이름 왼쪽 **체크를 해제**합니다.
2. **▶** 를 누르고 **`Game` 창 클릭** → **`W`** 를 눌러봅니다.
3. ▶ 를 끄고 **다시 체크**합니다. → **▶ 를 누르면 다시 걸어집니다.**

> 🟨 **확인 필요** — 흉내 내는 부품의 `W A S D` 는 **부품을 꺼도 움직일 수** 있습니다.
> 그 경우 이 단계는 **`Snap Turn Provider` 를 껐다 켜서 '돌기'로** 확인합니다.
...
1. ▶ 를 **끕니다.**
2. **`XR Origin (XR Rig)`** 의 조종석에서 **`Snap Turn Provider`** 체크를 **해제**합니다.
3. **`Continuous Turn Provider`** 체크는 **켜둡니다.**
...
??? success "정답 보기"
    **맨 위 `XR Origin (XR Rig)`(몸)** 에 들어 있습니다. **우리가 붙인 게 아니라 처음부터 있었습니다.**

    왜 몸이냐면 — **머리와 손의 위치는 고글과 조종기가 정하기 때문**입니다.
    거기에 이동을 붙여도 실행하는 순간 **덮어씌워집니다.**

    움직이는 건 **언제나 몸**입니다.

    !!! tip "그래서 VR에서 뭔가 이상하면"
        **`XR Origin` 부터 보세요.** 파묻히는 것도, 안 걸어지는 것도 거의 다 여기 있습니다.
